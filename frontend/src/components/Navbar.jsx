...
const Navbar = () => {
    ...
    return (
        <div className='bg-gray-100 h-10 w-[97%] mt-4 rounded-lg m-auto flex gap-20 justify-center items-center'>
            {/* Confessions Tab */}
            <Link to="/">
                <div className={`flex gap-2 px-6 py-1 rounded-md cursor-pointer ${location.pathname === '/' ? "bg-purple-300" : ""}`}>
            ...
            {/* Global Chat */}
            <Link to="/chat">
                <div className={`flex gap-2 px-6 py-1 rounded-md cursor-pointer ${location.pathname === '/chat' ? "bg-red-300" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"} fill={"none"}>
            ...
            {/* Notices */}
            <Link to="/notice">
                <div className={`flex gap-2 px-6 py-1 rounded-md cursor-pointer ${location.pathname === '/notice' ? "bg-green-300" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"} fill={"none"}>
            ...
            {/* Marketplace */}
            <Link to="/market">
                <div className={`flex gap-2 px-6 py-1 rounded-md cursor-pointer ${location.pathname === '/market' ? "bg-blue-400" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"} fill={"none"}>
            ...
            {/* Marketplace */}
            <Link to="/laf">
                <div className={`flex gap-2 px-6 py-1 rounded-md cursor-pointer ${location.pathname === '/laf' ? "bg-blue-400" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"} fill={"none"}>
