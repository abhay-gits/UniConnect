...
const Navbar = () => {
    return (
        <div className='bg-gray-100 h-10 w-[97%] mt-4 rounded-lg m-auto flex gap-20 justify-center items-center cursor-pointer'>
            {/* Confessions Tab */}
            <div className='flex gap-2 bg-blue-200 px-6 py-1 rounded-md'>
                ...
                <p className='text-[#000000]'>Confessions</p>
            </div>
            {/* All Tab */}
            <div className='flex gap-2 px-6 py-1 rounded-md'>
